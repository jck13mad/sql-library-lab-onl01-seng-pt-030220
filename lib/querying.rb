def select_books_titles_and_years_in_first_series_order_by_year
  ...
  JOIN series ON books.series_id = series.id WHERE series.id = 1 
  ORDER BY books.year;"
end
...
def select_series_title_with_most_human_characters
  ...
  JOIN characters ON character_books.character_id = characters.id WHERE characters.species = 'human' 
